...
file_path=os.path.join("figure","Times Series of Three Classes.png") 
...
print(cm)
file_path=os.path.join("figure","Confusion matrix of Shapelet Example.png") 
...
file_path=os.path.join("figure","Shapelet and Test Set.png") 
...
plt.title("Shapelet and Test Set")
plt.savefig(os.path.join(file_path))
plt.close()

file_path=os.path.join("figure","Shapelet and Train Set.png") 
plt.figure(figsize=(10, 6))
